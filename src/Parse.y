...
Transition : 'behaviour' id 'of' id
             ...
             list(Precondition)
             Cases
             opt(Ensures)                             { Transition (name $ arg $2) (name $ arg $4)
                                                        $5 $6 $7 $8 }
...
Constructor : 'constructor' 'of' id
              ...
              list(ExtStorage)
              opt(Ensures)
              opt(Invariants)                          { Definition (name $ arg $3)
                                                         $4 $5 $6 $7 $8 $9 }
...
Interface : 'interface' id '(' seplist(Decl, ',') ')' { Interface (name $ arg $2) $4 }
...
ExtStorage : 'storage' id nonempty(Store)             { ExtStorage (name $ arg $2) $3 }
           | 'creates' id 'at' Expr nonempty(Assign)  { ExtCreates (name $ arg $2) $4 $5 }
...
Entry : id list(Zoom)                                 { Entry (posn $1) (name $ arg $1) $2 }
      | '_'                                           { Wild }
...
Decl : Type id                                        { Decl $1 (name $ arg $2) }

StorageVar : SlotType id                            { StorageVar $1 (name $ arg $2) }
...
Type : 'uint'
     ...
     | Type '[' ilit ']'                              { AbiArrayType (fromIntegral $ value $ arg $3) $1 }
...
Expr : '(' Expr ')'                                    { $2 }
  ...
  -- terminals
  | ilit                                                { IntLit (posn $1) (value $ arg $1) }
  | '_'                                                 { WildExp (posn $1) }
  ...
  | id list(Zoom)                                       { EntryExp (posn $1) (name $ arg $1) $2 }
--  | id list(Zoom)                                       { Look (posn $1) (name $ arg $1) $2 }
